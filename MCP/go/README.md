# Geocoder REST API MCP Server

This MCP (Model Content Protocol) server provides access to Geocoder REST API API functionality through HTTP, HTTPS, and STDIO transport modes.
