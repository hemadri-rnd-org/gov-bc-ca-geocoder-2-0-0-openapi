...
func Get_addresses_outputformatHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/addresses.%s%s", cfg.BaseURL, outputFormat, queryString)
...
func CreateGet_addresses_outputformatTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_addresses_outputFormat",
		mcp.WithDescription("Geocode an address"),
		...
		mcp.WithString("addressString", mcp.Description("Civic or intersection address as a single string. See <a href=https://github.com/bcgov/ols-geocoder/blob/gh-pages/glossary.md#addressString target=\"_blank\">addressString</a>")),
		...
		mcp.WithString("streetQualifier", mcp.Description("Example: the Bridge in Johnson St Bridge. The qualifier of a street name. See <a href=https://github.com/bcgov/ols-geocoder/blob/gh-pages/glossary.md#streetQualifier target=\"_blank\">streetQualifier</a>")),
		mcp.WithString("localityName", mcp.Description("The name of the locality assigned to a given site by an address authority. See <a href=https://github.com/bcgov/ols-geocoder/blob/gh-pages/glossary.md#localityName target=\"_blank\">localityName</a>")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_addresses_outputformatHandler(cfg),
	}
}
