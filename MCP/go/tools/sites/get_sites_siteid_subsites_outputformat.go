...
func Get_sites_siteid_subsites_outputformatHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/sites/%s/subsites.%s%s", cfg.BaseURL, siteID, outputFormat, queryString)
...
func CreateGet_sites_siteid_subsites_outputformatTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_sites_siteID_subsites_outputFormat",
		mcp.WithDescription("Represents all subsites of a given site"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_sites_siteid_subsites_outputformatHandler(cfg),
	}
}
