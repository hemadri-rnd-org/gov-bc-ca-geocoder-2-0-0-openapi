...
func Get_sites_within_outputformatHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/sites/within.%s%s", cfg.BaseURL, outputFormat, queryString)
...
func CreateGet_sites_within_outputformatTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_sites_within_outputFormat",
		mcp.WithDescription("Find sites in a geographic area"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_sites_within_outputformatHandler(cfg),
	}
}
