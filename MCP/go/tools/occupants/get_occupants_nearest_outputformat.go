...
func Get_occupants_nearest_outputformatHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/occupants/nearest.%s%s", cfg.BaseURL, outputFormat, queryString)
...
func CreateGet_occupants_nearest_outputformatTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_occupants_nearest_outputFormat",
		mcp.WithDescription("Find occupants of the site nearest to a geographic point"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_occupants_nearest_outputformatHandler(cfg),
	}
}
